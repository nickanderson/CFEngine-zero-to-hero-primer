...
- [[https://leanpub.com/learning-cfengine/][Learning CFEngine]]
...
#+BEGIN_EXAMPLE
  ...
  {                             |
    packages:                   | rpm -q openssh-server || yum install openssh-server
      redhat|centos::           | yum check-update openssh-server
...
#+BEGIN_SRC sh
  ...
  if [ $? -eq 100 ]; then # update available
    yum upgrade openssh-server
  fi 
#+END_SRC

#+BEGIN_NOTES
- Commonly
  - expect to start and end at known states
  - repute tasks unnecessarily on subsequent execution
...
:Attachments: Screenshot_20190724_115600_2019-07-24_11-56-55.png
:REVEAL_BACKGROUND: ./data/9c/0c5886-4b07-423e-9e4a-0b55a73515b7/Screenshot_20190724_115600_2019-07-24_11-56-55.png
:REVEAL_BACKGROUND_SIZE: 600px
:REVEAL_BACKGROUND_OPACITY: 10
:END:

** Promise Theory

- *fundamental underlying philosophy* that drives CFEngine
- *model of voluntary cooperation between individual, autonomous actors*

#+BEGIN_NOTES
It is a *model of voluntary cooperation between individual, autonomous actors*
or agents who publish their intentions to one another in the form of promises.
#+END_NOTES
